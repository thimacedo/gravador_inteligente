...
from app.tratamento_audio import TratamentoConfig, process as processar_audio
from app.edicao_boletins import EdicaoConfig, editar_boletim
from app.montagem_boletins import MontagemConfig, AssetsConfig, montar_boletim
...
class PipelineBoletins:
    ...
    def executar(
        ...
        logger.info("=" * 70)
        logger.info(f"PIPELINE DE BOLETINS - Iniciando")
...
def main_cli():
    ...
    parser = argparse.ArgumentParser(
        description="Pipeline completo de produção de boletins"
    )
